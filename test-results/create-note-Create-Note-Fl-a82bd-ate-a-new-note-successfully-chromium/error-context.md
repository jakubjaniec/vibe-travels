...
- Name: Create Note Flow >> should create a new note successfully
- Location: /Users/jakubjaniec/development/projects/vibe-travels/e2e/create-note.spec.ts:17:3
...
Call log:
  - waiting for getByTestId('login-email-input')
    ...
    at /Users/jakubjaniec/development/projects/vibe-travels/e2e/create-note.spec.ts:20:21
```
