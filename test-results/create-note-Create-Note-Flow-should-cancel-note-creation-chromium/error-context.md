...
- Location: /Users/jakubjaniec/development/projects/vibe-travels/e2e/create-note.spec.ts:59:3
...
Call log:
  - waiting for getByTestId('login-email-input')
    ...
    at /Users/jakubjaniec/development/projects/vibe-travels/e2e/create-note.spec.ts:62:21
```
