...
- Name: Create Note Flow >> should validate note form fields
- Location: /Users/jakubjaniec/development/projects/vibe-travels/e2e/create-note.spec.ts:39:3
...
Call log:
  - waiting for getByTestId('login-email-input')
    ...
    at /Users/jakubjaniec/development/projects/vibe-travels/e2e/create-note.spec.ts:42:21
```
